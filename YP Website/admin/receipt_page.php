        ...
        .hidden{
         ...
         <script>
          function myPrint(div_name, hidden_div) {
              ...
              var myPrintWindow = window.open('http://localhost/php/YP-Powertools-Website/YP%20Website/admin/receipt_page.php');
      ...
      <tbody>
        ...
        <?php foreach($order_history as $key => $item): ?>
          ...
          <tr>
            ...
            ?>
            <td>
              <button type="button" class="btn btn-info float-right" data-toggle="modal" data-target="#historyModal<?php echo $modal_counter ?>" data-whatever="@mdo" style="width: 72px;margin-bottom: 6px;">Info</button>
             ...
             <div class="col-lg-6 mx-auto">
                 <table class="table table-dark table-bordered">
                    ...
                    <tbody>
                       <tr>
                          <th scope="row"><?php echo $order_history[$modal_counter]['account_name'] ?> </th>
                          <th scope="row"><?php echo commafy($order_history[$modal_counter]['total_price']) ?> </th>
